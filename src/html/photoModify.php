...
<header>
    ...
    <div id="photoUpload">
         <div class="photoModify"></div>
        <img id="imgModify" class="photos">
    </div>
<div class="upload">
<h4>图片标题</h4>
...
<button onclick="modify()" style="margin-top:20px;margin-left:30px;">Modify</button>
<footer >
    <p id="footer">Copyright &copy; 2019-2020. All rights reserved 备案号：19302010046</p>
</footer> <!--网页版权信息-->
<script src="../javascript/Modefy.js"></script>
<script src="../javascript/Modify2.js"></script>
</body>
