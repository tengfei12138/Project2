...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../css/5.css" media="all">
</head>
<body>
<header>
    <div class="nav">
        <ul>
            ...
            <li><a class="dropdown" style="color:green;">My account</a>
                <ul>
                    ...
                    <li><a href="mycollection.php"></i> 我的收藏</a> </li>
                    <li><a href="myphoto.php" style="color:green;"> 我的照片</a></li>
...
<div class="sidebar">
    <div class="tab"  style="width:1300px;"><i class="reorder"></i> My Photo</div>
</div> <!--分割栏-->
<div>
...
<script src="../javascript/myPhoto.js"></script>
</body>
</html>